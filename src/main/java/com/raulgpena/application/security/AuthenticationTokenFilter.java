...
/**
 * 
 *  <p>The class <code>com.raulgpena.application.security.AuthenticationTokenFilter</code> is a filter
 *     for management the token filter.
 *  
 *  
...
public class AuthenticationTokenFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /**
     * 
     *  <p>Method that set the tokenUtils bean.
     *  
     *  @param tokenUtils tokenUtils bean.
    ...
    /**
     * 
     *  <p>Method that set the userDetailsService bean.
     *  
     *  @param userDetailsService userDetailsService bean.
     *  @see   org.springframework.beans.factory.annotation.Autowired
     *  @see   org.springframework.security.core.userdetails.UserDetailsService
